    ...
    layui.extend({
        ...
        tableIns = table.render({
            ...
            , cols: [[   //列表数据
                ...
                , {field: 'userid', title: '传感器ID', align: 'center',width:'15%'}
                , {field: 'realname', title: '压力值', align: 'center',width:'15%'}
                , {field: 'loginname', title: '上传数据时间', align: 'center',width:'15%'}
                , {field: 'identity', title: 'rssi值', align: 'center',width:'15%'}
                , {field: 'phone', title: '传感器状态', align: 'center',width:'15%'}
                , {field: 'address', title: '传感器地址', align: 'center',width:'20%'}
            ]],
