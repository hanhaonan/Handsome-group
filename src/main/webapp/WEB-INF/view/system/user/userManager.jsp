...
<div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-block">
        <textarea class="layui-textarea" placeholder="请输入内容">根据2018FS，要求RBOL提供2.5亿美元的新资金。</textarea>
    </div>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea class="layui-textarea" placeholder="请输入内容"> Ledoux，Lew＆Patterson保险经纪有限公司（LLP）成立于1969年，并获得许可销售所有类别的保险业务。</textarea>
        </div>

        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
            <legend>法律结构与治理</legend>
        </fieldset>
        <div class="layui-form-item layui-form-text">
            <%--            <label class="layui-form-label">法律结构与治理</label>--%>
            <div class="layui-input-block">
                <textarea class="layui-textarea" placeholder="请输入内容">成立于1995年的有限公司
                  所有权
                  史蒂文·海西50％
                  德怀特·希克森50%</textarea>
            </div>
