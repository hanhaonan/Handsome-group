...
<div class="layui-row">
    <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
        <div class="layui-inline">
            <label class="layui-form-label"style="width: 150px">上次批准</label>
    ...
    <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
        <label class="layui-form-label"style="width: 150px">上次批准分数</label>
        <div class="layui-input-inline" style="padding: 5px">
            <input type="text" name="roledesc" autocomplete="off" class="layui-input layui-input-inline"
                   placeholder="5.8474" style="height: 30px;border-radius: 10px">
        </div>
    </div>
    <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
        <label class="layui-form-label"style="width: 150px">上次批准日期</label>
        <div class="layui-input-inline" style="padding: 5px">
            <input type="text" name="roledesc" autocomplete="off" class="layui-input layui-input-inline"
                   placeholder="20181120" style="height: 30px;border-radius: 10px">
        </div>
    </div>
    <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
    </div>
...
<div class="layui-row">
    <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
        <div class="layui-inline">
            <label class="layui-form-label"style="width: 150px">计算</label>
            <div class="layui-input-inline" style="padding: 5px">
                <input type="text" name="roledesc" autocomplete="off" class="layui-input layui-input-inline"
                       placeholder="3+M" style="height: 30px;border-radius: 10px">
            </div>
    ...
    <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
        <label class="layui-form-label"style="width: 150px">调整后</label>
        <div class="layui-input-inline" style="padding: 5px">
            <input type="text" name="roledesc" autocomplete="off" class="layui-input layui-input-inline"
                   placeholder="3+M" style="height: 30px;border-radius: 10px">
        </div>
    ...
    <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
        <label class="layui-form-label"style="width: 150px">调整后上线</label>
        <div class="layui-input-inline" style="padding: 5px">
            <input type="text" name="roledesc" autocomplete="off" class="layui-input layui-input-inline"
                   placeholder="3+M" style="height: 30px;border-radius: 10px">
        </div>
...
<div class="layui-row">
    <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
        <div class="layui-inline">
            <label class="layui-form-label"style="width: 150px">最终评</label>
            <div class="layui-input-inline" style="padding: 5px">
                <input type="text" name="roledesc" autocomplete="off" class="layui-input layui-input-inline"
                       placeholder="3+M" style="height: 30px;border-radius: 10px">
            </div>
    ...
    <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
        <label class="layui-form-label"style="width: 150px">最终得分</label>
        <div class="layui-input-inline" style="padding: 5px">
            <input type="text" name="roledesc" autocomplete="off" class="layui-input layui-input-inline"
                   placeholder="5.8474" style="height: 30px;border-radius: 10px">
        </div>
    ...
    <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
        <label class="layui-form-label"style="width: 150px">覆盖</label>
        <div class="layui-input-inline" style="padding: 5px">
    ...
    <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
        <label class="layui-form-label"style="width: 150px">覆盖原理</label>
        <div class="layui-input-inline" style="padding: 5px">
            <input type="text" name="roledesc" autocomplete="off" class="layui-input layui-input-inline"
                   placeholder="5.8474" style="height: 30px;border-radius: 10px">
        </div>
...
<form class="layui-form" method="post" id="searchFrm">
    <div class="layui-row">
        <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
            <label class="layui-form-label">Outlook</label>
            <div class="layui-inline">
                <select name="city" lay-verify="">
        ...
        <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
            <label class="layui-form-label">BCC</label>
            <div class="layui-inline">
                <select name="city" lay-verify="">
                    <option value="012">10 SAT</option>
                    <option value="010">Yes</option>
                    <option value="011">No</option>
                    <option value="013">N/A</option>
                </select>
        ...
        <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
            <div class="layui-inline">
                <label class="layui-form-label"style="width: 150px">下一次审核日期</label>
                <div class="layui-input-inline" style="padding: 5px">
                    <input type="text"  id="test1" readonly="readonly"
                           class="layui-input layui-input-inline"
                           placeholder="2020-11-30" style="height: 30px;border-radius: 10px">
                </div>
            </div>
        </div>
