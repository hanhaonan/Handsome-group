...
public class InitMenuData {
    public static void main(String[] args) {
        ...
        menuMapper.insert(new Menu(1,0,"火灾展示系统",null,1,null,"&#xe68e;",1));
        menuMapper.insert(new Menu(2,1,"流量分析系统",null,1,null,"&#xe621;",1));
        menuMapper.insert(new Menu(3,1,"数据实时分析",null,0,null,"&#xe663;",1));
        menuMapper.insert(new Menu(4,1,"系统管理",null,0,null,"&#xe716;",1));
        menuMapper.insert(new Menu(5,1,"统计分析",null,0,null,"&#xe629;",1));

        //基础管理子节点
        menuMapper.insert(new Menu(6,2,"火灾传感器数据统计",null,0,null,"&#xe770;",1));
        menuMapper.insert(new Menu(7,2,"剧情分析",null,0,null,"&#xe657;",1));
